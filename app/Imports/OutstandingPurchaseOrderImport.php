...
class OutstandingPurchaseOrderImport implements ToCollection, WithHeadingRow
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            $departmentName = $this->resolveKeys($rowData, ['department_name', 'department', 'dept', 'dept_pemesan', 'departemen', 'department_pemesan', 'pemesan', 'user_dept']);
            ...
            $erpReceivedQty = $this->resolveKeys($rowData, ['erp_received_qty', 'received_qty', 'qty_terima', 'qty_received']) ?: 0;
            $erpOutstandingQty = $this->resolveKeys($rowData, ['erp_outstanding_qty', 'outstanding_qty', 'pending_qty', 'qty_outstanding', 'sisa_qty', 'sisa']);
