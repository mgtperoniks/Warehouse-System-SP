...
<body class="bg-surface text-on-surface flex min-h-screen antialiased">
    ...
    <div class="fixed bottom-16 right-4 z-50 p-3 bg-slate-950/95 border border-slate-800 rounded-lg text-[9px] font-mono text-slate-400 shadow-2xl max-w-sm uppercase tracking-wider backdrop-blur-md">
