...
<body class="bg-surface text-on-surface flex min-h-screen antialiased">
    ...
    <aside class="fixed left-0 top-0 h-full p-2 h-screen w-[84px] hidden lg:flex flex-col border-r border-slate-200 dark:border-slate-800 bg-slate-100/85 dark:bg-slate-900/85 backdrop-blur-md z-40">
        ...
        <div class="flex-1 overflow-y-auto space-y-4 pb-6 pr-1 custom-sidebar-scroll">
            ...
            <!-- Group: Receiving -->
            <div>
                <div class="text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase text-center select-none py-1 border-t border-slate-200/50 dark:border-slate-850 mt-2 mb-1">REC</div>
                <div class="space-y-2">
                    <a class="relative group/nav flex items-center justify-center w-12 h-12 mx-auto {{ request()->routeIs('outstanding-purchases') || request()->routeIs('outstanding-purchases.show') || request()->routeIs('outstanding-purchases.import') ? 'bg-slate-200/90 dark:bg-slate-800/90 text-green-700 dark:text-green-300 border-l-[5px] border-green-600 shadow-sm font-bold' : 'text-slate-655 dark:text-slate-400 hover:bg-slate-200/60 dark:hover:bg-slate-800/60' }} rounded-xl transition-all duration-200" href="{{ route('outstanding-purchases') }}">
            ...
            <div>
                ...
                <div class="space-y-2">
                    ...
                    <a class="relative group/nav flex items-center justify-center w-12 h-12 mx-auto {{ request()->routeIs('governance.audit-coverage') ? 'bg-slate-200/90 dark:bg-slate-800/90 text-green-700 dark:text-green-300 border-l-[5px] border-green-600 shadow-sm font-bold' : 'text-slate-655 dark:text-slate-400 hover:bg-slate-200/60 dark:hover:bg-slate-800/60' }} rounded-xl transition-all duration-200" href="{{ route('governance.audit-coverage') }}">
