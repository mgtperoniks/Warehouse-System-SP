...
<div class="pt-24 px-4 pb-6 lg:px-8 min-h-screen flex flex-col">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div class="flex flex-wrap gap-3 w-full md:w-auto" x-data>
            <a href="{{ route('items.bulk-import') }}" class="flex-1 md:flex-none justify-center bg-surface-container-high text-primary px-5 py-3 rounded-2xl font-black text-sm flex items-center gap-2 hover:bg-slate-200 transition-colors active:scale-95 shadow-sm">
